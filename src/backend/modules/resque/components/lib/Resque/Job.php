...
use backend\modules\resque\components\Constant;
...
use backend\modules\resque\components\lib\Resque\Job\Resque_Job_DontPerform;
...
class Resque_Job
{
     ...
     * @return null object when there aren't any waiting jobs, instance of Resque_Job when a job was found.
     */
...
//         return true;
    ...
    public function recreate($enqueuedAt = 0, $isLast = false)
    {
        ...
        Resque_Event::trigger ( 'afterRetry', array (

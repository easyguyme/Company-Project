...
/**
 * stats Analysic how many codes to be redeemed
 */
class StatsPromotionCodeAnalysisController extends Controller
{
    /**
    ...
    public function actionUpdateData($beginTime = '', $endTime = '', $type = '')
    {
        ...
        $jobId = Yii::$app->job->create('backend\modules\product\job\StatsPromotionCodeAnalysisUpdate', $args, null, null, false);
        echo $jobId . PHP_EOL;
    }
}

...
namespace backend\modules\resque\components\lib\Resque\Job;
...
class Resque_Job_Status
{
    ...
    /**
     * Create a new status monitor item for the supplied job ID.
     * Will create
     ...
     *
     * @param
     *            int The status of the job (see constants in Resque_Job_Status)
     */

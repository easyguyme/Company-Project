...
use backend\modules\resque\components\lib\Credis\Credis_Client;

require_once dirname ( __FILE__ ) . '/../Credis/Client.php';

if (class_exists ( 'Redis', false )) {

    class RedisApi extends \Redis
    {
        private static $defaultNamespace = 'wmresque:';
    ...
    class RedisApi
    {
        ...
        public function __construct($server, $database = null, $newPassword = '')
        {
            $this->server = $server;
        ...
        /**
         * Get the key prefix in redis
         *
         * @return the key prefix in redis
         */
        ...
        /**
         * Get the key in redis without prefix
         *
         * @param string $string
         *            the key with prefix
